...
import com.Smartcartt.app.Model.VendorOrders;
import com.firebase.ui.database.FirebaseRecyclerAdapter;
import com.firebase.ui.database.FirebaseRecyclerOptions;
import com.google.firebase.database.DatabaseReference;
import com.google.firebase.database.FirebaseDatabase;

public class Vendor_New_Orders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ordersRef = FirebaseDatabase.getInstance().getReference().child("Vendors").child(Current.currentOnlineUser.getPhone()).child("Orders");
                    ...
                    protected void onBindViewHolder(@NonNull VendorOrdersViewHolder holder, final int position, @NonNull final VendorOrders model) {
                        ...
                        holder.showOrdersBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent = new Intent(Vendor_New_Orders.this, Vendor_User_Products_Activity.class);
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(Vendor_New_Orders.this);
                                builder.setTitle("Have you delivered this order products?");
                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        if (i==0){
                                           ordersRef.child("state").setValue("Delivered");

                                            FirebaseDatabase.getInstance().getReference().child("Users").child(model.getPhone()).child("OrderPlaced").removeValue();
    ...
    public static class VendorOrdersViewHolder extends RecyclerView.ViewHolder {
        ...
        public VendorOrdersViewHolder(View itemView) {
            super(itemView);
